...
export class HCommandPaletteComponent implements OnDestroy {
  ...
  readonly queryInput = input('', { alias: 'query' });
  readonly query = linkedSignal(this.queryInput);
