...
class StoryModalHostComponent {
  ...
  openConfirm(): void {
    const ref = this._modal.open(DemoConfirmContentComponent, {
  ...
  openForm(): void {
    const ref = this._modal.open(DemoFormContentComponent, {
  ...
  openData(): void {
    const ref = this._modal.open(DemoDataContentComponent, {
      title: 'Injected data',
